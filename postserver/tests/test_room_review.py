...
class TestRoomReview:
    ...
    def test_patch_an_existing_room_review(self, test_app):
        review_id = 1
    ...
    def test_patch_a_non_existent_room_review(self, test_app):
        not_existent_room_review_id = 25
    ...
    def test_patch_a_room_review_from_a_not_existing_room(self, test_app):
        room_review_id = 1
