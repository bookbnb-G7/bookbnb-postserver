...
class TestRoomRating:
    ...
    def test_patch_an_existing_room_rating(self, test_app):
        rating_id = 1

        room_rating_patch = {"rating": 0}
        ...
        room_rating_reset_patch = {"rating": test_room_rating_payload["rating"]}
    ...
    def test_patch_a_non_existent_room_rating(self, test_app):
        not_existent_room_rating_id = 25
    ...
    def test_patch_a_room_rating_from_a_not_existing_room(self, test_app):
        room_rating_id = 1
        ...
        response = test_app.patch(
            url="/rooms/" + str(non_existent_room_id) + "/ratings/" + str(room_rating_id),
            headers=header,
            data=json.dumps(room_rating_patch),
        )
